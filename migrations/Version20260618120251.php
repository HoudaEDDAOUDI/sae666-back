 ...
 */
final class Version20260618120251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD winner_id INT DEFAULT NULL, DROP id_winner');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD id_winner INT NOT NULL, DROP winner_id');
    }
}
